...
const copySubDomain = require('./gulp/tasks/copySubDomain');
...
const dev = gulp.parallel(pug2html, script, vendors, styles, imageMinify, spriteSVG, spritePNG, fonts, videos, copySubDomain);
